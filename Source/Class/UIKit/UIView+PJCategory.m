...
#import "UIView+PJCategory.h"

@implementation UIView (PJIBInspect)

@dynamic borderColor, borderWidth, cornerRadius, maskToBounds;
...
-(void)setMaskToBounds:(BOOL)maskToBounds {
    [self.layer setMasksToBounds:maskToBounds];
}

@end

@implementation UIView(PJAnimation)
...
@implementation UIView (PJCategory)
...
- (NSArray<UIView *> *)pj_recurrenceAllSubviews {
    ...
    void (^getSubViewsBlock)(UIView *current) = ^(UIView *current) {
        ...
        for (UIView *sub in current.subviews) {
            [all addObjectsFromArray:[sub pj_recurrenceAllSubviews]];
        }
    };
